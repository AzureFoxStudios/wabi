...
export const DEFAULT_CHANNEL_RETENTION = '24h';
...
export function effectiveChannelRetention(duration, opts) {
    if (opts?.persistForever)
        return null;
    if (duration === null)
        return null;
    if (duration === undefined)
        return DEFAULT_CHANNEL_RETENTION;
    return duration;
}
