...
$env:STATE_BACKEND_MODE = "legacy"
$env:STATE_STDB_READ_ENABLED = "false"
$env:STATE_STDB_WRITE_ENABLED = "false"
$env:STATE_BACKEND_STRICT = "false"
$env:STATE_STDB_SUBSCRIPTIONS_ENABLED = "false"
$env:STATE_SHADOW_WRITER_ENABLED = "false"
$env:STATE_SHADOW_SINK = "mirror"
