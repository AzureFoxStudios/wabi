...
- Wabi targets SpacetimeDB as the shared state plane, with IndexedDB reserved for client-local cache.
...
Instead of trying to preserve legacy database semantics everywhere:
