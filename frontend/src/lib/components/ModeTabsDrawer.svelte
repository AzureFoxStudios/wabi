...
<style>
	...
	.drawer-toggle {
		...
		border: none;
		border-radius: 8px;
		background: var(--surface-base, #2b2d35);
	...
	.drawer-toggle.has-tabs {
		background: var(--surface-raised, #3f4254);
	...
	.toggle-indicator-bookmarks {
		background: color-mix(in srgb, var(--color-warning) 78%, white 22%);
	}
	...
	.drawer-header {
		...
		border-bottom: 1px solid rgba(var(--text-inverse-rgb, 255, 255, 255), 0.06);
	}
	...
	.drawer-sections {
		...
		border: 1px solid rgba(var(--text-inverse-rgb, 255, 255, 255), 0.06);
		overflow: hidden;
	}
	...
	.drawer-section-highlight {
		...
		border-radius: 10px;
		background:
			linear-gradient(180deg, color-mix(in srgb, var(--accent-primary, var(--color-info, var(--color-info, #6366f1))) 24%, rgba(var(--text-inverse-rgb, 255, 255, 255), 0.08)), color-mix(in srgb, var(--accent-primary, var(--color-info, var(--color-info, #6366f1))) 14%, transparent));
		box-shadow:
			inset 0 1px 0 rgba(var(--text-inverse-rgb, 255, 255, 255), 0.1),
			0 8px 20px var(--shadow-sm, var(--shadow-md, var(--shadow-md, rgba(0, 0, 0, 0.22))));
	...
	.section-tab-count {
		...
		padding: 0 5px;
		border-radius: 999px;
		background: rgba(var(--text-inverse-rgb, 255, 255, 255), 0.09);
		color: inherit;
		display: inline-flex;
		align-items: center;
		justify-content: center;
	...
	.followed-server-header.current .followed-server-copy strong {
		color: color-mix(in srgb, var(--accent-primary, var(--color-info, var(--color-info, #6366f1))) 62%, white 20%);
	}
	...
	.drawer-item-row {
		...
		background: rgba(var(--text-inverse-rgb, 255, 255, 255), 0.02);
	}

	.drawer-item-row.active {
		border-color: color-mix(in srgb, var(--accent-primary, var(--color-info, var(--color-info, #6366f1))) 55%, transparent);
		background: color-mix(in srgb, var(--accent-primary, var(--color-info, var(--color-info, #6366f1))) 14%, transparent);
	}
	...
	.item-list-grouped .drawer-item-row + .drawer-item-row {
		border-top: 1px solid rgba(var(--text-inverse-rgb, 255, 255, 255), 0.06);
	}
	...
	.item-badge {
		...
		padding: 0 5px;
		border-radius: 9px;
		background: var(--color-danger, var(--color-danger, #b91c1c));
	...
	@media (max-width: 768px) {
		...
		.drawer-panel.embedded {
			...
			max-height: none;
			border-radius: 16px;
			border-bottom: 1px solid rgba(var(--text-inverse-rgb, 255, 255, 255), 0.1);
		}
	}
</style>
