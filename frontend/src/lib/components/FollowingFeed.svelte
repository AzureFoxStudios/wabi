...
<style>
	.following-feed {
		...
		background:
			...
			linear-gradient(180deg, rgba(7, 12, 18, 0.98), rgba(10, 15, 24, 0.96));
		overflow: hidden;
	...
	.following-hero {
		...
		border-radius: 22px;
		background: linear-gradient(145deg, rgba(17, 24, 39, 0.92), rgba(15, 23, 42, 0.82));
	...
	.follow-card.active {
		...
		box-shadow: 0 16px 34px rgba(45, 212, 191, 0.16);
	}
