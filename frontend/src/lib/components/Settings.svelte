		...
		>
			...
			<div class="settings-layout">
				...
				<div class="settings-tabs">
					...
					<button class="settings-tab" class:active={activeSettingsTab === 'audio'} on:click={() => activeSettingsTab = 'audio'}>Audio & Video</button>
...
<style>
	...
	/* Mobile responsive: tabs go horizontal */
