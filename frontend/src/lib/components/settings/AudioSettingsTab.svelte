...
<div class="settings-section">
	...
	<div class="media-quality-notice" role="note">
		...
		<div class="setting-item"><div class="setting-info"><span class="setting-label">Experimental wabiDB Calls</span><span class="setting-description">Desktop-only experimental path for DM/group calls. Channel voice calls stay on standard routing.</span></div><button class="toggle-btn" class:active={experimentalWabidbCallsEnabled} on:click={toggleExperimentalWabidbCalls} disabled={!desktopLocalAppRuntime} title="Experimental desktop wabiDB routing for DM/group calls only">{experimentalWabidbCallsEnabled ? 'ON' : 'OFF'}</button></div>
