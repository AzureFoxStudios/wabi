...
<style>
	...
	.server-pill.drop-inside {
		...
		background: linear-gradient(135deg, rgba(56, 189, 248, 0.24), rgba(45, 212, 191, 0.18));
	}
	...
	.server-unread-badge {
		...
		box-shadow: 0 6px 18px rgba(239, 68, 68, 0.34);
		pointer-events: none;
	}
	...
	.folder-popout {
		...
		background:
			...
			radial-gradient(circle at top right, rgba(45, 212, 191, 0.14), transparent 50%);
	...
	.folder-member.active {
		border-color: rgba(94, 234, 212, 0.48);
		background: linear-gradient(135deg, rgba(45, 212, 191, 0.24), rgba(59, 130, 246, 0.18));
	}
