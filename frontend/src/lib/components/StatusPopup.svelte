...
<style>
	...
	.status-button {
		...
		box-shadow: 0 2px 8px var(--shadow-sm, var(--shadow-lg, rgba(0, 0, 0, 0.3)));
	}

	.status-button:hover {
		transform: scale(1.1);
		box-shadow: 0 4px 12px var(--shadow-md, var(--surface-modal-overlay, rgba(0, 0, 0, 0.4)));
	}
	...
	.status-options {
		...
		border-radius: 8px;
		padding: 8px;
		box-shadow: 0 4px 16px var(--shadow-md, var(--surface-modal-overlay, rgba(0, 0, 0, 0.4)));
		min-width: 140px;
	}
