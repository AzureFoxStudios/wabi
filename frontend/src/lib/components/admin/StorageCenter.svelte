...
<style>
	...
	.storage-center .explorer header { flex-wrap: wrap; }
	.storage-center .explorer header > div:first-child { flex: 1 1 320px; }
	.storage-center .filters { flex: 1 1 340px; min-width: 0; flex-wrap: wrap; max-width: 100%; }
	.storage-center .filters input { flex: 1 1 180px; min-width: 0; }
	.storage-center .filters select { flex: 0 1 140px; min-width: 0; }
</style>
