...
- Files GF07: 21/21 PASS (fixture `frontend/scripts/files-workspace-browser-smoke.mjs`)
...
## Bugs found by testing, then fixed (5 product fixes)
...
- Evidence dirs: `/tmp/wabi-gallery-browser-7GNQdX/` (15/0), `/tmp/wabi-files-gf07-m77HKG/` (21/0)
